      ...
      <div className="mx-auto max-w-4xl rounded-2xl bg-white shadow-xl" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between border-b px-6 py-4">
          <div>
            ...
            <div className="mt-1 text-xs text-amber-700">Preview feature — under active development. Output and availability may change.</div>
          </div>
        ...
        <div className="space-y-6 px-6 py-5">
          {!insights ? (
            <div className="text-sm text-slate-600">No insights available yet. This is a preview feature—start a run and check back once it completes.</div>
          ) : (
            <>
              <section>
